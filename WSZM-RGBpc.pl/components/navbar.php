<section id="menu"class="hover:w-[400px] lg:hover:w-1/5 w-[130px] lg:w-1/5 h-screen flex flex-col items-center justify-between bg-[#f8f9fa] py-5 pl-8 pr-4 font-[Lexend]  transition-all duration-300">
