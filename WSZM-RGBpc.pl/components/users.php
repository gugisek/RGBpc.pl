...
if ($action=="edit") {
    ...
    if(mysqli_num_rows($result) > 0)
    {
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            echo "<label for='name' class='text-sm text-gray-500'>Imię</label>";
            echo "<input type='text' name='name' id='name' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent' value='".$row['name']."'>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='sur_name' class='text-sm text-gray-500'>Nazwisko</label>";
            echo "<input type='text' name='sur_name' id='sur_name' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent' value='".$row['sur_name']."'>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='mail' class='text-sm text-gray-500'>E-mail</label>";
            echo "<input type='text' name='mail' id='mail' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent' value='".$row['mail']."'>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='role' class='text-sm text-gray-500'>Rola</label>";
            echo "<select name='role' id='role' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent'>";
            ...
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='status' class='text-sm text-gray-500'>Status</label>";
            echo "<select name='status' id='status' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent'>";
            ...
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='create_date' class='text-sm text-gray-500'>Data utworzenia</label>";
            echo "<input type='text' name='create_date' id='create_date' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent' value='".substr($create_date, 0, strrpos($create_date, ' ', 0))."' disabled>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='password' class='text-sm text-gray-500'>Hasło</label>";
            echo "<input type='password' name='password' id='password' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent'>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
            echo "<label for='password2' class='text-sm text-gray-500'>Powtórz hasło</label>";
            echo "<input type='password' name='password2' id='password2' class='w-full py-2 px-4 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent'>";
            echo "</div>";
            echo "<div class='flex flex-row gap-2'>";
            echo "<button type='submit' class='w-full py-2 px-4 bg-green-500 hover:bg-green-600 rounded-lg text-white font-medium'>Zapisz</button>";
            echo "<a href='?page=użytkownicy&action=' class='w-full py-2 px-4 bg-red-500 hover:bg-red-600 rounded-lg text-white font-medium'>Anuluj</a>";
            echo "</div>";
            echo "</form>";
            echo "</section>";
        }
