<?php
if ($action == "add_out") {
    echo "<section id='add_out' class='w-full bg-white shadow-xl rounded-3xl py-6 px-6'>";
        echo "<h1 class='pb-2 font-medium text-gray-600 font-[Lexend]'>Dodaj zamówienie wychodzące</h1>";
        echo "<form action='order_scripts/orders_back_add.php' method='post' enctype='multipart/form-data' class='flex flex-col gap-4'>";
            ...
            echo "<div class='flex flex-col gap-2'>";
                ...
                echo "<input required readonly type='text' name='seller' id='seller' value='RGBPC.PL' class='w-full py-2 px-4 rounded-lg shadow-sm text-gray-700 outline-none focus:text-gray-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent uppercase'>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
                echo "<label for='client' class='text-xs text-gray-500'>Kupujący</label>";
                echo "<input required type='text' name='client' id='client' class='w-full py-2 px-4 rounded-lg shadow-sm text-gray-700 outline-none focus:text-gray-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent'>";
            echo "</div>";
            echo "<div class='flex flex-col gap-2'>";
