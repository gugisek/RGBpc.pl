<form action="panel.php?page=produkty&action=&search_status=1" method="POST" class="w-full flex gap-6">
    ...
    <input type="text" placeholder="<?php if (isset($_POST['search']) && $_POST['search']!="") { echo $_POST['search']; } else { echo "Podaj nazwę lub SKU"; } ?>" name="search" id="search" class="w-full outline-none font-light">
