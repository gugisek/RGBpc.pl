<form action="panel.php?page=produkty&action=&search_status=1" method="POST" class="w-full flex gap-6">
    ...
    <?php include 'products_search_category.php'; ?>
    <?php include 'products_search_quantity.php'; ?>
    <?php include 'products_search_status.php'; ?>
    <button>
...
<form class="flex gap-2" method="POST" action="?page=produkty&action=">
