<form action="panel.php?page=użytkownicy&action=&search_status=1" method="POST" class="w-full flex gap-6">
...
<form class="flex gap-2" method="POST" action="?page=użytkownicy&action=">
