<div class="relative isolate bg-white">
  <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
    <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
      <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg mt-[8vh]">
        ...
        <h2 class="text-4xl font-[poppins] font-bold tracking-tight text-gray-900">Get in touch</h2>
    ...
    <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48 mt-[8vh]">
      <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
        ...
        <div class="mt-8 flex justify-end">
          <button type="submit" class="flex w-full items-center justify-center flex flex-row items-center justify-center gap-2 text-sm font-semibold leading-6 text-black hover:bg-violet-600/30 px-8 py-2 bg-violet-100 rounded-lg hover:text-violet-500 druation-150 active:scale-95 transition-all">Send message</button>
        </div>
      </div>
    </form>
  </div>
