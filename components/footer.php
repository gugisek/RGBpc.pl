<footer class="bg-white" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
        <img class="h-7" src="img/logo2.png" alt="Company name">
        <p class="text-sm leading-6 text-gray-600">Sklep komputerowy ukierunkowany na tuningu wizualnym komputerów. Robimy również strony internetowe i zarządzamy nimi.</p>
        <div class="flex space-x-6">
          <a href="#" class="text-gray-400 hover:text-violet-500 duration-100">
          ...
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="50">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Marketing</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Analytics</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="150">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Commerce</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Insights</a>
              </li>
            </ul>
          </div>
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              ...
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="350">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Guides</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="400">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">API Status</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="450">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">O nas</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="500">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Kontakt</a>
              </li>
          ...
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="600">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Reklamacje</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="650">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Dostawy</a>
              </li>
              <li data-aos="fade-right" data-aos-anchor-placement="bottom-bottom" data-aos-delay="700">
                <a href="#" class="text-sm leading-6 text-gray-600 hover:text-violet-500 duration-100">Polityka prywatności</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
      <p class="text-xs leading-5 text-gray-500">&copy; 2019 - 2024 RGBpc.pl, usługi komputerowe. All rights reserved.</p>
    </div>
  </div>
</footer>
