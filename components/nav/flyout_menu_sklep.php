<div id="fly_Sklep" class="menu opacity-0 duration-200 pointer-events-none absolute top-0 z-[51] mt-14 ring-gray-900/5 inset-x-0">
    <div class="absolute left-1/2 z-10 mt-5 flex w-screen -translate-x-1/2 grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-6 py-10 lg:grid-cols-2 lg:px-8 bg-white/95 backdrop-blur-lg mt-4 shadow-lg rounded-3xl ring-gray-900/5 ring-1">
      <div class="grid grid-cols-2 gap-x-6 sm:gap-x-8">
        <div>
          <h3 class="text-sm font-medium leading-6 text-gray-500">Sklep</h3>
