                ...
                <table class="w-full" data-aos="fade-in" data-aos-delay="100">
                    <tr class=" text-left text-xs text-gray-400 ">
                        ...
                        <th class="sticky top-0 z-10 hidden border-b border-gray-300 bg-white bg-opacity-75 py-3.5 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter lg:table-cell py-3 w-1/6">Data</th>
                        <th class="sticky top-0 z-10 hidden border-b border-gray-300 bg-white bg-opacity-75 py-3.5 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter lg:table-cell w-[35%] md:table-cell hidden">Opis</th>
