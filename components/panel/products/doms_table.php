            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div onclick="openPopupDoms('.$row['id'].')" class="grid grid-cols-8 text-sm text-gray-600 font-[poppins] rounded-2xl hover:bg-gray-200 cursor-pointer active:scale-95 duration-150">
                        ...
                        <div class="font-medium py-5 pl-4 pr-3 sm:pl-6 items-center text-gray-600 xl:flex hidden">
                            '. $row['category'] .'
                        </div>
                        ...
                        <div id="status_dom_'.$row['id'].'" class="font-medium py-5 pl-4 pr-3 sm:pl-6 flex items-center ';
