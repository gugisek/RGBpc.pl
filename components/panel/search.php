<div onclick="openSearch()" id="searchMainBg" class="opacity-0 h-0 fixed inset-0 z-[51] bg-gray-900/40 transition-opacity"></div>

<div onclick="openSearch()" id="searchMain" class="scale-0 fixed inset-0 z-[52] overflow-y-auto p-4 sm:p-6 md:p-20">
  <div onclick="window.event.cancelBubble = true;" class="mx-auto max-w-2xl transform divide-y divide-gray-500 divide-opacity-10 overflow-hidden rounded-3xl bg-white bg-opacity-80 shadow-2xl ring-1 ring-black ring-opacity-5 backdrop-blur backdrop-filter transition-all">
    <div class="relative">
      ...
      <input type="text" class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-900 focus:ring-1 ring-violet-600 druation-150 focus:outline-none sm:text-sm" placeholder="Wyszukaj np. nazwę produktu, numer seryjny, SKU">
    </div>
