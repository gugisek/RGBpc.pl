...
if (!empty($message) && !empty($product_id)) {
    include '../conn_db.php';
            ...
            $sql = "INSERT INTO `time_lines` (`id`, `object_id`, `object_type`, `create_date`, `user_id`, `type_id`, `message`) VALUES (NULL, '$product_id', 'products_doms', current_timestamp(), '$user_id', '3', '$message')";
